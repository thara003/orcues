    ...
    <div className=" mt-14 flex h-[100vh] w-[100%] flex-col flex-wrap items-center ">
      ...
      <div className="mx-auto mb-10 mt-20 max-w-md px-2.5 text-center sm:max-w-lg sm:px-0">
        ...
        <div className="flex-warp flex flex-col items-center justify-center ">
          ...
          <h2 className="specialElite mt-5 text-lg text-gray-600 sm:text-xl">
        ...
        <div className="mx-auto mt-10 flex max-w-fit space-x-4">
          ...
          <a className="flex items-center justify-center space-x-2 rounded-full border border-gray-300 bg-white px-5 py-2 shadow-lg transition-all hover:border-gray-800">
